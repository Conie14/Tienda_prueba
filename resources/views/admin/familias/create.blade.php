<x-admin-layout :breadcrumbs="[
    ...
    [
        'name' => 'Crear Nueva Familia',
        'route' => route('admin.familias.create'),
    ],
]">

<div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-4">
    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Crear Nueva Familia</h2>
    <div class="card">
        <form action="{{ route('admin.familias.store') }}" method="POST" class="mt-4">
            @csrf
