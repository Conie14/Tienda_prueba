        ...
        @if ($subcategorias->count() > 0)
                ...
                <table id="familiasTable" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <!-- Columna de familia -->
                            <th scope="col" class="px-6 py-3 text-center cursor-pointer" data-sort="familia">
                                <div class="flex items-center justify-center">
                                    Categoria
                                    <span class="sort-icon ml-1"></span>
                                </div>
            ...
            <div class="mt-4 flex flex-col md:flex-row items-center justify-between">
                <div class="text-sm text-gray-700 mb-4 md:mb-0">
                    Mostrando <span id="showingStart">1</span> a <span id="showingEnd">10</span> de <span id="totalEntries">{{ $subcategorias->count() }}</span> entradas
                </div>
